...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-3"><span class="text-muted fw-light">Absensi Kelas /</span> Tambah</h4>
        <div class="row">
            <div class="col-md-12">
                <div class="card mb-4">
                    <h5 class="card-header">Form Tambah Absensi Kelas</h5>
                    <div class="card-body">
                        <form action="{{ route('absensi.store') }}" method="POST" class="form_tambah_absensi"
                            id="form_tambah_absensi">
                            @csrf
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control @error('pertemuan_ke') is-invalid @enderror"
                                    id="pertemuan_ke" placeholder="Contoh: 2" value="{{ old('pertemuan_ke') }}"
                                    name="pertemuan_ke" />
                                @error('pertemuan_ke')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control @error('tanggal') is-invalid @enderror" name="materi_kuliah" id="materi_kuliah" cols="30"
                                    rows="3">{{ old('materi_kuliah') }}</textarea>
                                @error('materi_kuliah')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
